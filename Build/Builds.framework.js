...
var ASM_CONSTS = {
  5032320: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 5032375: function($0) {performance.now = function() { return $0; };},  
 5032423: function($0) {performance.now = function() { return $0; };},  
 5032471: function() {performance.now = Module['emscripten_get_now_backup'];},  
 5032526: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 5032587: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 5032651: function() {return Module.webglContextAttributes.powerPreference;}
};
  ...
  function _PlayRawAudioData(audioDataPointer, length) {
      var audioData = new Float32Array(Module.HEAPF32.buffer, audioDataPointer, length);
      var source = window.audioContext.createBufferSource();
      var audioBuffer = window.audioContext.createBuffer(1, audioData.length, window.audioContext.sampleRate);
  ...
  function _initializeConvaiClient(apiKey, characterId, enableAudioRecorder, enableAudioPlayer) {
      ...
      console.log("Inside initializeConvaiClient");
      console.log("api key: " + UTF8ToString(apiKey) + "\nCharacterID: " + UTF8ToString(characterId));
      console
      this.convaiClient = new convai.ConvaiClient({
      ...
      this.convaiClient.setResponseCallback(function (response) {
        ...
        if (response.hasUserQuery()) {
          ...
          if (isFinal) {
            ...
            SendMessage("ConvaiGRPCWebAPI", "OnUserResponseRecieved", this.userTextStream);
          }
        ...
        if (response.hasAudioResponse()) {
          ...
          for (var i = 0, j = 0; i < audioData.length; i += chunkSize, j++) {
            ...
            console.log(tempAudioData);
            var dataString = JSON.stringify(audioRes);
  
            SendMessage("ConvaiGRPCWebAPI", "OnAudioResponseRecieved", dataString);
          }
        }
...
var asmLibraryArg = {
  ...
  "InitAudioContext": _InitAudioContext,
  ...
  "OpenUrl": _OpenUrl,
  "PlayRawAudioData": _PlayRawAudioData,
